...
public abstract class BattleLoc extends Location {
    ...
    public boolean getLocation() {
        ...
        while (!selCase.equals("S") && !selCase.equals("K")) {
            ...
            if (!selCase.equals("S") && !selCase.equals("K")) {
                System.out.println("Geçerli bir seçenek girin (S veya K).");
            }
        }
        ...
        for (int i = 0; i < obsCount; i++) {
            ...
            while (player.getHealthy() > 0 && obstacle.getHealth() > 0) {
                ...
                while (!selCase.equals("V") && !selCase.equals("K")) {
                    ...
                    selCase = scan.nextLine().toUpperCase();
                    if (!selCase.equals("V") && !selCase.equals("K")) {
                        System.out.println("Lütfen geçerli bir seçenek girin (V veya K).");
                    }
                }
